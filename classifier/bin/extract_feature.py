...
def extractfeature(imagedir, labelfilename, protofilename, pretrainedname,
    ...
    for line in reader:
        try:
            ...
            featurefile.write("%d %s\n" % (int(line[1]), ' '.join(["%d:%f" % (i, fi) for i, fi in enumerate(scaledfeature, start=1)])))
        except IOError as e:
            print(e)
...
if __name__ == '__main__':
    ...
    extractfeature(IMAGE_DIR, LABEL_FILE, PROTO_FILE, PRETRAINED, MEAN_FILE, FEATURE_FILE)
